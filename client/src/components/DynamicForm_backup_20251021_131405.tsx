...
export function DynamicForm({ mode, onGenerate, isGenerating = false }: DynamicFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (mode === "template") {
      requiredSelects.push("tone");
      if (isCollapsibleOpen) {
        requiredSelects.push("finalOutputFormat");
      }
      requiredSelects.push("outputFormat", "accuracyLevel");
    } else if (mode === "agent") {
    ...
    if (mode === "template") {
      ...
      const conditionalFields = [
        ...
        { id: "finalOutputFormat", value: data.finalOutputFormat },
